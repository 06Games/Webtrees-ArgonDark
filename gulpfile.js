...
function copyLightTheme() {
    return gulp.src('vendor/evang/argon-light/resources/**/*')
...
exports.build = gulp.series(
    clean,
    gulp.parallel(buildWebtreesCss, scss, jsTranspile, copyLightTheme),
    gulp.parallel(cssBuild, jsBuild, copyViews, copyModule)
);
exports.default = gulp.parallel(buildWebtreesCss, scss, jsTranspile, copyLightTheme);
